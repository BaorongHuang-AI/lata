...
const HomePage = () => {
    ...
    const getDocTypeFromStatus = (status: string): "doc" | "para" | "sent" => {
        ...
        // fallback for completed or unknown
        return "doc";
    };

    const handleExport = async (doc: AlignedDocument) => {
        setExportingId(String(doc.id));
        try {
    ...
    return (
        <div className="p-6 max-w-12xl mx-auto space-y-8">
